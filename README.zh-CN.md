...
- 支持 Kimi 订阅额度：优先显示接口提供的会员月额度，并分别显示周限额和 5 小时限额；弹窗与 Widget 同步显示
- 弹窗显示剩余额度和下次重置时间
- 显示当前套餐和限额名称
- 每五分钟自动刷新
- 支持手动刷新
...
- Kimi 数据：读取本机 kimi-code 凭证，仅用于 Kimi 官方认证与额度接口
...
Codex 数据的认证和令牌刷新由本机 Codex app-server 负责。Kimi 数据则读取并原地刷新
